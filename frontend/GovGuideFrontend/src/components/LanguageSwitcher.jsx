...
export default function LanguageSwitcher() {
  ...
  return (
    <div ref={dropdownRef} className="relative inline-block">
      ...
      <div
        className={`
                    absolute top-full mt-2 min-w-max z-50
                    bg-[var(--background-primary)] border border-[var(--border)]
                    rounded-lg shadow-lg origin-top
      ...
      >
        {languages.map((lang) => (
          <button
            ...
            className={`w-full text-left px-4 py-3 flex items-center gap-2 transition-colors duration-150 ${
